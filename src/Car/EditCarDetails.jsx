...
const CarDetails = ({ setCurrentDate, setCurrentTime, currentDate, currentTime, places, setPlaces }) => {
  const { inputdata, setInputData, usereditbooking, setusereditbooking, verifieduser } = useContext(CarContextDetails);
...
const PaymentDetails = ({ currentDate, currentTime, places, setPlaces }) => {
